    ...
    <div v-show="showFlag" class="food" ref="food">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <!--:select-type="selectType" :only-content="onlyContent"传入参数-->
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      show() {
        this.showFlag = true;
        //进入每个商品详情的时候，下面这两个状态都是all和true
        this.selectType=ALL,
        this.onlyContent=true,
        this.$nextTick(()=>{
          if(!this.scroll){
            this.scroll=new BScroll(this.$refs.food,{//这里的food是<div v-show="showFlag" class="food" ref="food">中ref后面的food
              click:true
            });
          }else{
            this.scroll.refresh();
      ...
      addFirst(event){
        ...
        Vue.set(this.food,'count',1)//加入属性count，并设为1
     },
      selectRating(type){
